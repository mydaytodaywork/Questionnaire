...
<body>
	...
	<form class='form4' action='page5.php' method='POST'>
		...
		<h1><u>Circulation:-</u></h1>
		<div class='a'>1) Mention the number of books that the following categories of users are entitled to borrow with loan period:<div>
		
		<table>
		<thead><tr><th>User Category</th><th>No. of books entitled to borrow</th><th>Loan period ( in days ) </th></tr></thead>
		<tbody>
			
			<tr><td>UG</td><td><input class='txt' size=50 type='text' name='tform4_1'/></td><td><input class='txt' size=50 type='text' name='tform4_2'/></td></tr>
			<tr><td>PG</td><td><input class='txt' size=50 type='text' name='tform4_3'/></td><td><input class='txt' size=50 type='text' name='tform4_4'/></td></tr>
			<tr><td>Faculty</td><td><input class='txt' size=50 type='text' name='tform4_5'/></td><td><input class='txt' size=50 type='text' name='tform4_6'/></td></tr>
			<tr><td>Staff</td><td><input class='txt' size=50 type='text' name='tform4_100'/></td><td><input class='txt' size=50 type='text' name='tform4_101'/></td></tr>
		</tbody>
		</table>
		...
		<tr><td>3) If 'Yes' please mention</td><td><input class='txt' size=50 type='text' name='tform4_7'/></td></tr>
		<tr><td>4) Give average number of the books issued daily to:</td><td></td></tr>

		<tr><td class='sub'>a) PG students</td><td><input class='txt' size=50 type='text' name='tform4_8'/></td></tr>
		<tr><td class='sub'>b) UG students</td><td><input class='txt' size=50 type='text' name='tform4_9'/></td></tr>
		<tr><td class='sub'>c) Teachers</td><td><input class='txt' size=50 type='text' name='tform4_10'/></td></tr>
		...
		<tr><td class='sub'>a) Students</td><td><input class='txt' size=50 type='text' name='tform4_11'/></td></tr>
		<tr><td class='sub'>b) Teachers</td><td><input class='txt' size=50 type='text' name='tform4_12'/></td></tr>
		...
		<tr><td>9) If 'yes' for what kind of information do they expect it?</td><td><input class='txt' size=50 type='text' name='tform4_13'/></td></tr>
		</table>
