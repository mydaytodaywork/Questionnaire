...
if(isset($_POST['tform4_1'])){
	...
	$q4 = "INSERT INTO `survey4`(`slno`, `tform4_1`, `tform4_2`, `tform4_3`, `tform4_4`, `tform4_5`, `tform4_6`,
	 `tform4_7`, `tform4_8`, `tform4_9`, `tform4_10`, `tform4_11`, `tform4_12`, `tform4_13`,`form4_1`,`form4_2`,`form4_3`,`form4_4`) 
...
<body>
	...
	<form class='form5' action='thanks.php' method='POST'>
		<table class='table5'>
			<tr><td><h2>Other Users and Services</h2></td><td></td></tr>
			...
			<tr><td>2) State the form of reference service you provide</td><td><input class='txt' size=40 type='text' name='tform5_1'/></td></tr>
			...
			<tr><td>5) If 'yes' how do you provide it?</td><td><input class='txt' size=40 type='text' name='tform5_2'/></td></tr>
			...
			<tr><td>7) If 'yes' on which occasions do you arrange these?</td><td><input class='txt' size=40 type='text' name='tform5_3'/></td></tr>
			...
			<tr><td>10) If 'Yes' how many copies of document a user is entitled to get copied?</td><td><input class='txt' size=40 type='text' name='tform5_4'/></td></tr>
			<tr><td>11) What are the per copy charges?</td><td></td></tr>
			<tr><td class='sub'>a) For Teachers</td><td><input class='txt' size=40 type='text' name='tform5_5'/></td></tr>
			<tr><td class='sub'>b) For Students</td><td><input class='txt' size=40 type='text' name='tform5_6'/></td></tr>
			...
			<tr><td>13) If 'Yes' which resources do you share and with which libraries?</td><td><input class='txt' size=40 type='text' name='tform5_7'/></td></tr>
			...
			<tr><td><h2>Others</h2></td><td></td></tr>
			...
			<tr><td class='sub2'>e) Any other</td><td><input class='txt' size=40 type='text' name='tform5_8'/></td></tr>

			<tr><td>2) Mention other methods you use to promote use of libraries</td><td><input class='txt' size=40 type='text' name='tform5_9'/></td></tr>
			<tr><td>3) Do you face any difficulties in managing library and proving services to users?(Mention those)</td><td><input class='txt' size=40 type='text' name='tform5_10'/></td></tr>
			<tr><td>4) What do you suggest to make your library more effective?</td><td><input class='txt' size=40 type='text' name='tform5_11'/></td></tr>
			<tr><td>5) What are your future plans for the library?</td><td><input class='txt' size=40 type='text' name='tform5_12'/></td></tr>
